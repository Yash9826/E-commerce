...
public class customerPurchaseServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int qnty = Integer.parseInt(request.getParameter("p_qnty"));
            String mrp = request.getParameter("p_mrp");
            String pricing = request.getParameter("p_pricing");

            CustomerDAO dao = new CustomerDAO(ConnectionProvider.getConnection());
            Product p = new Product(name, qnty, pricing, mrp, id);
